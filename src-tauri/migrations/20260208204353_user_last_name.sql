...
INSERT INTO users_new (id, username, firstname, lastname, email, phone, synced, date_added)
SELECT id, username, NULL AS firstname, NULL AS lastname, email, phone, synced, 0 FROM users;
