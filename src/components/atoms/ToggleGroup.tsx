...
export const ToggleGroup = ({ options, value, onChange, variant }: ToggleGroupProps) => {
			...
			{options.map((option) => (
				<button
					...
					className={cn(
						...
						value === option.value
							? onPrimary ? "bg-white text-accent-primary" : "bg-accent-primary text-white"
							: onPrimary ? "text-white" : "text-text-on-light",
					)}
